...
function render() {
  ...
  renderLiveView(effectiveStory, lastReport, lastFeedback, liveStage, mergedTimeline);
  ...
  applyDiagramState(liveStage.activeNodes);
}
...
function renderLiveView(story, lastReport, lastFeedback, liveStage, timeline) {
...
function applyDiagramState(activeNodes) {
...
function deriveLiveStage(story, timeline) {
